	...
	[
		{
			...
			setUp: function(){
				...
				dojo.forEach(partLocaleList, function(locale){
					dojo.requireLocalization("dojo.cldr", "gregorian", locale, "aa,af,am,be,bg,ar,as,ca,bn,az,da,de,cs,cy,fa,el,en,eo,es,fi,et,eu,ga,fo,fr,ha,gl,he,hi,gu,gv,id,ig,hr,ii,hu,ja,in,hy,is,it,ka,iw,kk,kl,km,kn,ko,kw,lt,mk,lv,ml,nb,mn,mo,ne,mr,ms,mt,nl,nn,no,pa,om,or,pl,ps,pt,ro,sh,si,ru,sk,sl,ta,so,te,sq,sr,th,ti,sv,sw,tl,tr,uk,ur,vi,yo,zh,zu,byn,fil,haw,kok,syr,ar-jo,ar-lb,ar-qa,ar-sa,ar-tn,ar-sy,ar-ye,de-be,de-at,fa-af,en-be,en-au,en-ca,en-bw,en-bz,en-gb,en-hk,en-ie,en-in,en-mt,en-nz,en-pk,en-sg,en-za,en-zw,es-ar,es-cl,es-co,es-ec,es-es,es-gt,es-hn,es-pa,es-pe,es-pr,es-us,fr-be,fr-ca,fr-ch,it-ch,it-it,ko-kr,ms-bn,nl-be,pa-pk,pt-br,pt-pt,se-fi,ru-ua,sr-ba,ti-er,sv-fi,zh-cn,zh-hk,zh-mo,zh-sg,zh-tw,ROOT,zh-hant,zh-hans-sg,zh-hant-hk,zh-hant-mo,en-dsrt,en-shaw,hy-am-revised,sr-latn,el-polyton,pa-arab,uz-latn,az-cyrl,sr-latn-me,sr-cyrl-ba");
				});
			},
			runTest: function(t){
			},
