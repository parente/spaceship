{
    ...
    EARN_AMMO_MESSAGE : 'Get ready to earn ammo!',
    EARN_SHIELD_MESSAGE : 'Get ready to earn shields!',
    AVOID_FIRE_MESSAGE : 'Watch out! Avoid enemy fire!',
    AVOID_WARP_MESSAGE : 'Quickly! Stop warping enemies!',
    // HUD
    HUD_SHIPS: 'Ships',
    HUD_SHIELDS : 'Shields',
    HUD_AMMO : 'Ammo boxes'
